...
namespace StockSharp.Designer
{
	...
	public partial class DiagramDebuggerPanel
	{
		...
		public static readonly DependencyProperty StrategyProperty = DependencyProperty.Register(nameof(Strategy), typeof(DiagramStrategy), typeof(DiagramDebuggerPanel),
		...
		{
			((DiagramDebuggerPanel)sender).OnStrategyPropertyChanged((DiagramStrategy)args.NewValue);
		}
